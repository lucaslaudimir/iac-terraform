...
# Equivalente aos Parameters que eram preenchidos no Service Catalog
# ============================================================
...
# Rede
vpc_id          = "vpc-CHANGE_ME_HML"
private_subnets = ["subnet-CHANGE_ME_HML_A", "subnet-CHANGE_ME_HML_B"]
...
aurora_db_sg_id                = "sg-CHANGE_ME_HML_DB"
...
# Security Group do microserviço Operation
operation_sg_id = "sg-CHANGE_ME_HML_OPERATION"

# ALB / Listener
health_check_path       = "/healthcheck"
shared_load_balancer_sg = "sg-CHANGE_ME_HML_ALB"
listener_alb_arn        = "arn:aws:elasticloadbalancing:us-east-1:ACCOUNT:listener/app/alb-hml/CHANGE_ME"
